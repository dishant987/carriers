...
const page = () => {
  return (
    <>
      <Head>
        <title>Career Assessment Results | Your Scores & Strengths</title>
        <meta
          name="description"
          content="View your career assessment results, including scores for self-awareness, creativity, financial rewards, and more."
        />
        <meta
          name="keywords"
          content="career, assessment, self-awareness, creativity, financial rewards, security, stability"
        />
        <meta name="author" content="Dishant Shaileshbhai Tank" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta property="og:title" content="Career Assessment Results" />
        <meta
          property="og:description"
          content="Explore your career assessment scores and key strengths."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://yourwebsite.com/career-results"
        />
      </Head>
      <div className="">
        {/* Title */}
