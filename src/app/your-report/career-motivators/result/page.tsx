...
const page = () => {
  return (
    <>
      <Head>
        <title>Your Result - Career Insights</title>
        <meta
          name="description"
          content="Discover your career preferences based on various attributes like achievement, financial rewards, creativity, and more."
        />
        <meta
          name="keywords"
          content="career, results, job preferences, work styles, achievements"
        />
        <meta name="author" content="Your Website Name" />
        <meta property="og:title" content="Your Result - Career Insights" />
        <meta
          property="og:description"
          content="Discover your career preferences based on various attributes like achievement, financial rewards, creativity, and more."
        />
        <meta property="og:image" content="/career-results-thumbnail.jpg" />
